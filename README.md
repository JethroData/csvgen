...
number | Generates a whole or decimal number | <ul><li>Min - minimum value, mandatory</li><li>Max - maximum value, mandatory</li><li>Decimal - the number of decimal places (0 for whole), mandatory</li><li>Null % - the % of NULL values, 0-100, optional</li></ul>	| number 1 100 0 10, number 100 999 2 20
